...
class Sistema {
	private:
		...
		unsigned int m_next_user_id = 0;
		unsigned int m_next_server_id = 0;
  	...
  	public:
		...
		*/
		...
		/*! Retorna um id válido que pode ser atribuido a um usuário recém criado.
			@return o valor do id gerado
		*/
		...
		*/
		...
		/*! Retorna um id válido que pode ser atribuido a um servidor recém criado.
			@return o valor do id gerado
		*/
